...
public class Controller {
	...
	public static void main(String[] args) throws Exception {
		/*
		 * IMPORTANTE: Un par de notas aqu�. Primero, es imposible hacer retrieve de las queries totales;
		 * as� que insistir con triplas o bgps nomas. Piden mucha memoria, tendr僘 que hacer uso de HDD
		 * para ir guard疣dolas, y no vale la pena.
		 */
